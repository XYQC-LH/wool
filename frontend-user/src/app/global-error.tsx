      ...
      <body>
        <div className="min-h-screen flex items-center justify-center bg-background p-4">
          <div className="max-w-md w-full text-center">
            ...
            <h1 className="mb-2 text-4xl font-bold text-foreground">系统错误</h1>
            <h2 className="mb-4 text-2xl font-semibold text-foreground">应用程序遇到了严重错误</h2>
            <p className="mb-8 text-muted-foreground">抱歉，应用程序遇到了一个严重错误。请刷新页面或稍后再试。</p>
